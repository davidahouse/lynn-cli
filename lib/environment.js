 ...
 */
function gatherEnvironment(workingFolder, environmentFiles, currentProject) {
  const environment = {}
  ...
  envFiles.forEach(function(environmentFile) {
    const envFileName = files.findFile(workingFolder, environmentFile, 'environment', currentProject)
    if (envFileName != null) {
